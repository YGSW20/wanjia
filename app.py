...
def seed_data(db):
    ...
    # Override formula prices with real market data for key products
    real_overrides = {
        14:  {'闲鱼':(1389,1700),'京东':(1500,1700),'淘宝':(1389,1650),'拼多多':(1389,1600),'得物':(1500,1800)},
        17:  {'闲鱼':(900,1100),'京东':(1000,1200),'淘宝':(950,1100),'拼多多':(900,1050),'得物':(1000,1250)},
        33:  {'闲鱼':(319,453),'京东':(350,450),'淘宝':(319,453),'拼多多':(319,420),'得物':(380,480)},
        34:  {'闲鱼':(395,441),'京东':(400,450),'淘宝':(395,441),'拼多多':(395,430),'得物':(420,480)},
        151: {'闲鱼':(199,345),'京东':(220,320),'淘宝':(199,345),'拼多多':(199,300),'得物':(240,360)},
        153: {'闲鱼':(220,315),'京东':(240,310),'淘宝':(220,315),'拼多多':(220,300),'得物':(260,340)},
        149: {'闲鱼':(216,219),'京东':(220,250),'淘宝':(216,219),'拼多多':(216,230),'得物':(230,260)},
        19:  {'闲鱼':(189,269),'京东':(210,270),'淘宝':(189,269),'拼多多':(189,250),'得物':(220,290)},
        160: {'闲鱼':(147,205),'京东':(160,200),'淘宝':(147,205),'拼多多':(147,190),'得物':(180,220)},
        116: {'闲鱼':(199,279),'京东':(220,280),'淘宝':(199,279),'拼多多':(199,260),'得物':(230,300)},
        145: {'闲鱼':(188,262),'京东':(200,260),'淘宝':(188,262),'拼多多':(188,240),'得物':(210,280)},
        192: {'闲鱼':(28,120),'京东':(50,120),'淘宝':(28,120),'拼多多':(28,100),'得物':(60,140)},
        94:  {'闲鱼':(210,305),'京东':(230,300),'淘宝':(210,305),'拼多多':(210,280),'得物':(240,320)},
        37:  {'闲鱼':(600,700),'京东':(620,700),'淘宝':(600,700),'拼多多':(600,680),'得物':(650,750)},
        35:  {'闲鱼':(435,445),'京东':(440,460),'淘宝':(435,445),'拼多多':(435,450),'得物':(450,480)},
        154: {'闲鱼':(427,481),'京东':(440,480),'淘宝':(427,481),'拼多多':(427,470),'得物':(460,520)},
        10:  {'闲鱼':(1320,2980),'京东':(1400,2800),'淘宝':(1320,2980),'拼多多':(1320,2700),'得物':(1500,3200)},
        220: {'闲鱼':(179,450),'京东':(200,400),'淘宝':(179,450),'拼多多':(179,350),'得物':(220,480)},
        270: {'闲鱼':(1649,2449),'京东':(1800,2300),'淘宝':(1744,2449),'拼多多':(1649,2100),'得物':(1800,2500)},
        300: {'闲鱼':(950,1899),'京东':(1200,1899),'淘宝':(950,1899),'拼多多':(950,1600),'得物':(1200,2000)},
    }
    for pid, platforms in real_overrides.items():
        for plat, (low, high) in platforms.items():
            db.execute('UPDATE prices SET price_low=?, price_high=?, source=1, reporter=?, updated_at=? WHERE product_id=? AND platform=?',
                       (low, high, 'Felix', now, pid, plat))
